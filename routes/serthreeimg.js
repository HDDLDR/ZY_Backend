...
router.post('/serthreeimg', function(req,res){
    console.log('>>>>>up');
...
router.get('/serthreeimg', function(req, response, next) {
...
function save(serhanzi,serenglish,serimg,callback) {
    pool.getConnection(function(err, connection) {
        var sql = "insert into serthreeimg (serid,serhanzi,serenglish,serimg) values (0,?,?,?)";
